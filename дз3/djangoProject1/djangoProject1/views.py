...
imageClassList = {14: 'butterfly', 44: 'lizard', 74: 'shrew'}
...
def predictImageData(modelName, filePath):
    ...
    sess = onnxruntime.InferenceSession(r'D:\мгту\7 сем\МППР\дз3\djangoProject\media\models\cifar100_CNN_RESNET20.onnx')
